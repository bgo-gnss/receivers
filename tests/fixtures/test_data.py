...
TIMESTAMP_NORMALIZATION_CASES = [
    ...
    },
    {
        ...
        "ffrequency": "1hr",
        "input_datetime": datetime(2025, 9, 24, 15, 30, 45),  # Downloaded at 3:30 PM
        "expected_normalized": datetime(
            2025, 9, 24, 15, 0, 0
        ),  # Normalized to hour boundary
...
ARCHIVE_DISCOVERY_CASES = [
    {
        ...
        "expected_path": TEST_ARCHIVE_DIR
        / "2025"
        / "sep"
        / "ELDC"
        / "15s_24hr"
