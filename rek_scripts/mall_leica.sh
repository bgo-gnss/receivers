...
do
    ...
    #rinfilelist=`timecalc -l "${pdir}/%Y/#b/${stat}/${freqd}/${rinexdir}/${stat}#Rin2${DZend} " 1D -D ${twindow}`
    ...
    do
        ...
        echo  "${rinexd}${rinexf}${DZend}"
        
       
        if [ -f ${rinexd}${rinexf}${DZend} ];
        then
            echo "File  ${rinexd}${rinexf}${DZend}, moving on ..."
            break
        fi
