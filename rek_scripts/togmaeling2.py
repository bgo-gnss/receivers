...
def download(args):
    ...
    downloaded_files = comfunc.ftp_download(files_to_download, tmpdir, clean_tmp=args.clean, ftp=ftp, pasv=False,    
                                                  ftp_close=False, sbase=r'[56].csv')
    ...
    backupdir = os.path.join(backupdir_pre, year,  )
    ...
    for f in downloaded_files:
        ...
        bfile="{}_{}{}".format( basen, currtime.strftime("%Y%m%d%H%M"),ext)
