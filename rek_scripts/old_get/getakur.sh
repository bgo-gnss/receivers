...
wget -S --passive-ftp ftp://213.167.147.213/gnsmart_data/$YEAR/$WEEK/$DOY/${STATION}${DOY}0.${YR}o
if [ -s ${STATION}${DOY}a.${YR}e ] 
then 
  echo "Found file ${STATION}${DOY}a.${YR}e on lmi ftp server, renaming and moving file to rinex directoy on dump...."
