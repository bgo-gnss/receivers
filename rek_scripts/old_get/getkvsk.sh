...
STATION=KVSK
STATION_FULL_NAME="Kvísker"
station=kvsk
sss=kvsk

IPNR=157.157.40.121     		# topcon ipnumber (for web interface use *:8080 otherwise you get the router)
IPNRFTP=157.157.40.121    		# topcon ipnumber
port=2160
PASSWORD=U0CNWSN
...
#echo curl ftp://${IPNR}:${port} --user sil:${PASSWORD} | grep '[A-Z][A-Z][A-Z][A-Z].*'   2>/dev/null
