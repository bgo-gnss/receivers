#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver GRVA
# SFS jun 2011: Adapted from getsoho.sh to download from HAUC which now has 3G conection.
#################
...
STATION=INSK
STATION_FULL_NAME="Innri-Skúti"
station=insk
sss=insk

IPNR=157.157.40.185:8080      		# netrs ipnumber
IPNRFTP=157.157.40.185:8080  		# netrs ipnumber
...
MONTHS=1 # number of months back in time to check files for
