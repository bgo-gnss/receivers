...
STATION=BALD
STATION_FULL_NAME="Búrfellsalda við Kárahnjúka"
station=bald
sss=bald

IPNR=localhost:8102      		# netrs ipnumber 
IPNRFTP=localhost:8102    		# netrs ipnumber
IPHOST=10.140.48.25
...
#python /usr/sil/gps/python2/baldConn.py
...
#python /usr/sil/gps/python2/baldDisConn.py
