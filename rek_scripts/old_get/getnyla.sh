#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver NYLA
...
STATION=NYLA
STATION_FULL_NAME="Nýlenda"
station=nyla
sss=nyla

IPNR=157.157.77.37:8060      		# netrs ipnumber 
IPNRFTP=157.157.77.37    		# netrs ipnumber
