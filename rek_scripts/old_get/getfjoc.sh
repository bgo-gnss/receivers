#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver FJOC
# SFS jun 2011: Adapted from getsoho.sh to download from FJOC which now has 3G conection.
#################
...
STATION=FJOC
STATION_FULL_NAME="Fjórðungsalda"
station=fjoc
sss=fjoc

IPNR=157.157.40.3:8080  		# netrs ipnumber 
IPNRFTP=157.157.40.3     		# netrs ipnumber
...
######## get b-file list:  #########
  ...
  do
    ...
    #scp $MDIR/b/$d pub@brunnur.vedur.is/srv/www/brunnur/pub/bgo/lmi/FJOC/ #coping to brunnur for LMI
  done            # closes file loop
done            # closes month loop
