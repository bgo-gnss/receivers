#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver SELF
#################
...
STATION=SELF
STATION_FULL_NAME="Selfoss - flugvöllur"
station=self
sss=self

IPNR=157.157.40.9:8080      		# netrs ipnumber 
IPNRFTP=157.157.40.9    		# netrs ipnumber
