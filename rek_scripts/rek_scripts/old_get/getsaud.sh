...
STATION=SAUD
STATION_FULL_NAME="Sauðárháls"
station=saud
sss=saud

IPNR=localhost:8103    		        # netrs ipnumber 
IPNRFTP=localhost:8103    		# netrs ipnumber
IPHOST=10.104.48.22
...
#python /usr/sil/gps/python2/saudConn.py
...
#python /usr/sil/gps/python/saudDisConn.py
