#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver HVEL
# SFS jun 2011: Adapted from getsoho.sh to download from HVEL which now has 3G conection through SIL station jok
#################
...
STATION=HVEL
STATION_FULL_NAME="Hveravellir"
station=hvel
sss=hvel

IPNR=157.157.222.91:8080      		# netrs ipnumber 
IPNRFTP=157.157.222.91    		# netrs ipnumber
