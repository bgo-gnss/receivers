#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver JOKU
# SFS jun 2011: Adapted from getsoho.sh to download from JOKU which now has 3G conection through SIL station jok
#################
...
STATION=JOKU
STATION_FULL_NAME="Jökulheimar"
station=joku
sss=joku

IPNR=157.157.145.118:8060      		# netrs ipnumber 
IPNRFTP=157.157.145.118    		# netrs ipnumber
