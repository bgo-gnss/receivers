#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver BUDH
...
STATION=BUDH
STATION_FULL_NAME="Búðarháls"
station=budh
sss=budh

#IPNR=79.134.238.254:8134      		# netrs ipnumber 
#IPNRF=79.134.238.254    		# netrs ipnumber
#IPNR=213.220.119.210:8134      		# netrs ipnumber 
#IPNRF=213.220.119.210    		# netrs ipnumber
IPNR=5.23.76.66:8134               # netrs ipnumber
IPNRF=5.23.76.66                   # netrs ipnumber
5.23.76.66
...
MONTHS=2 # number of months back in time to check files for
B_FILES=1 # Set to 1 to donwload also B (1Hz) files, else set to 0.
