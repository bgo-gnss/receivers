#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver FITC
# SFS jun 2011: Adapted from getsoho.sh to download from FITC.
# SFS may 2012: Adapted to communicate with a IP:PORT on a new connection instead of the 7-network.
#################
...
STATION=FITC
STATION_FULL_NAME="Fitjaás"
station=fitc
sss=fitc

#IPNR=79.134.238.254:8132                      # netrs ipnumber 
IPNR=5.23.76.66:8132
#IPNR=213.220.119.210:8132                      # netrs ipnumber 

#IPNRFTP=192.168.7.132                   # netrs ipnumber
#IPMAS=192.168.7.130                     # Freewave master
#IPSLA=192.168.7.131                     # Freewave slave
