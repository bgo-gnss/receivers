#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver SNAE
# SFS jun 2011: Adapted from getsoho.sh to download from SNAE which now has 3G conection.
#################
...
STATION=DYNC
STATION_FULL_NAME="Dyngjuháls"
station=dync
sss=dync

IPNR=157.157.40.107:8080      		# netrs ipnumber 
IPNRFTP=157.157.40.107:2121    		# netrs ipnumber
