#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver SARP
# SFS jun 2011: Adapted from getsoho.sh to download from SARP which now has 3G conection.
#################
...
STATION=HAMR
STATION_FULL_NAME="Hamragarðar"
station=hamr
sss=hamr

#IPNR=157.157.40.53:8080       		# netrs ipnumber #changed on 18.12.2012
#IPNRFTP=157.157.40.53     		# netrs ipnumber #changed on 18.12.2012
IPNR=157.157.40.147:8080       		# netrs ipnumber #changed on 18.12.2012
IPNRFTP=157.157.40.147     		# netrs ipnumber #changed on 18.12.2012
