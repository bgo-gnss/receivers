...
STATION=HAUD
STATION_FULL_NAME="Haukadalur"
station=haud
sss=haud

IPNR=localhost:8150      		# netrs ipnumber 
IPNRFTP=localhost:8150    		# netrs ipnumber
...
#python /usr/sil/gps/python2/haudDisConn.py
#python /usr/sil/gps/python2/haudDisConn.py
#python /usr/sil/gps/python2/haudConn.py
