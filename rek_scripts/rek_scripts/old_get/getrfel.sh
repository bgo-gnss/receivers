#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver RFEL
# SFS jun 2011: Adapted from getsoho.sh to download from GFUM which now has 3G connection.
# SFS may 2012: Adapted from getgfum.sh to download from RFEL directly insteda from strokkur.rhi.hi.is
#################
...
STATION=RFEL
STATION_FULL_NAME="Rjúpnafell"
station=rfle
sss=rfel

IPNR=157.157.145.107:8080      		# netrs ipnumber 
IPNRFTP=157.157.145.107    		# netrs ipnumber
