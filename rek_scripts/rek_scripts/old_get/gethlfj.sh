#!/bin/sh
# Hourly and daily download of Trimble NETRS receiver KALF
# SFS jun 2011: Adapted from getjoku.sh to download from KALF which now has 3G conection.
#################
...
STATION=HLFJ
STATION_FULL_NAME="Hlíðarfjall"
station=hlfj
sss=hlfj

IPNR=157.157.222.115:8080      		# netrs ipnumber 
IPNRFTP=157.157.222.115    		# netrs ipnumber
