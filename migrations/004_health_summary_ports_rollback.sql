-- Rollback: 004_health_summary_ports_rollback.sql
-- Description: Remove block_health_summary table and restore previous checkcomm view
-- Date: 2026-01-30
--
-- Usage:
--   psql -h localhost -U bgo -d gps_health -f migrations/004_health_summary_ports_rollback.sql

BEGIN;

-- Restore checkcomm view to previous version (from 003_satellite_tracking.sql)
...
-- Drop the health summary table
DROP TABLE IF EXISTS block_health_summary;
