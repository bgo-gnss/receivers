-- Rollback 034: restore health_good CTE with original (buggy) boolean conditions
...
DELETE FROM schema_migrations WHERE migration_name = '034_trimble_debounce_fix';
