-- Migration 027: Add staleness guards to connectivity and dashboard views
--
-- Problem: station_connectivity's port_debounced and latest_ntrip CTEs have no
-- timestamp filter. Stale port/NTRIP records (8h+) override current ping failures,
-- causing stations like OLAC/KASC/JONC/TANC to show "online" when unreachable.
--
-- Fix: Add 1-hour staleness filter to port_debounced and latest_ntrip CTEs.
-- When records are older than 1 hour, the CTE returns no rows → COALESCE
-- evaluates to false → station correctly shows as unreachable.
--
-- Base: migration 026 (station_dashboard_data with download performance columns)
...
-- ============================================================================
-- 2. Recreate station_connectivity with staleness guards
-- ============================================================================
...
-- ============================================================================
-- 3. Recreate station_dashboard_data (from 026 + staleness guard on NTRIP)
-- ============================================================================
...
-- ============================================================================
-- 4. Recreate station_data_flow_status (from 026, unchanged)
-- ============================================================================
