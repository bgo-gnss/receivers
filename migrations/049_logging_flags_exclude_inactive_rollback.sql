-- Rollback for migration 049: restore pre-049 logging flag logic (matches 041).
-- Reverts logging_15s / logging_1hz to count discontinued/inactive/suppressed/passive
-- stations as active loggers again. Only the two flag expressions differ from 049.
...
DELETE FROM schema_migrations WHERE migration_name = '049_logging_flags_exclude_inactive';
