...
class NetRSHTTPDownloader:
    ...
    def __init__(self, station_id: str, station_config: Dict[str, Any]):
        ...
        self.connect_timeout = netrs_config.get("http_timeout_connect", 30)
        self.stall_timeout = netrs_config.get("http_stall_timeout", 120)
    ...
    def download_file(self, remote_path: str, filename: str, local_path: Path,
        ...
        """Download a single file from NetRS receiver.
