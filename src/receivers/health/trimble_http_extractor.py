...
class TrimbleHTTPExtractor:
    ...
    def __init__(
        ...
        try:
            ...
            # silent=True: power_type is supplementary, and station_id is often a
            # probe placeholder (e.g. "BENCH") with no cfg section — matches the
            # PolaRX5 extractor; absence here is not an error.
