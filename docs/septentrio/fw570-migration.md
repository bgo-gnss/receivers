...
login, gpsops, GPS123ops, RxAdmin, S3pt3ntr10
...
- [x] TCP login succeeds with `gpsops` / `GPS123ops` — confirmed 2026-04-22
...
setUserAccessLevel, User1, gpsops, GPS123ops, User, AAAA...base64...==
