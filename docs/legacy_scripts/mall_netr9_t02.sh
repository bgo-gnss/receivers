...
do
  ...
  # if [ $SSS == AUST ] || [ $SSS = FIM2 ] || [ $SSS = ENTC ] || [ $SSS = HAFS ] || [ $SSS = OFEL ]  # This is to handle names that have "____" underscores in them... 
   ...
   #rsync -uva $LFILE ${RELBAS}.dat.Z ${RELBAS}.ion.Z ${RELBAS}.mes.Z ${RELBAS}.eph.Z sil@frumgogn:/home/sil/gps_01/qc/$SSS/raw/
   ehco "rsync-ing statistical files to frumgogn..."
   rsync -uva $QFIL $QCFIL sil@frumgogn:/home/sil/gps_01/qc/$SSS/qc/
   echo "rsync-ing the Z file to frumgogn..."
